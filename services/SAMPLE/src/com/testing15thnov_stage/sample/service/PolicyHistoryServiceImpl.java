 ...
 * @see PolicyHistory
 */
@Service("SAMPLE.PolicyHistoryService")
@Validated
public class PolicyHistoryServiceImpl implements PolicyHistoryService {
    ...
    @Autowired
    @Qualifier("SAMPLE.PolicyHistoryDao")
	...
	public PolicyHistory update(PolicyHistory policyHistory) throws EntityNotFoundException {
        ...
        policyhistoryId.setPolicyId(policyHistory.getPolicyId());
        policyhistoryId.setCoverage(policyHistory.getCoverage());
        policyhistoryId.setSysStart(policyHistory.getSysStart());
        policyhistoryId.setSysEnd(policyHistory.getSysEnd());
        policyhistoryId.setTransId(policyHistory.getTransId());
    ...
    public Downloadable export(ExportType exportType, String query, Pageable pageable) {
        LOGGER.debug("exporting data in the service SAMPLE for table PolicyHistory to {} format", exportType);
