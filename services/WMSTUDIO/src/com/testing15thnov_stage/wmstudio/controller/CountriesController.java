...
import com.testing15thnov_stage.wmstudio.Countries;
import com.testing15thnov_stage.wmstudio.service.CountriesService;
...
public Countries createCountries(@RequestBody Countries countries) {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Countries editCountries(@PathVariable("id") String id, @RequestBody Countries countries) throws EntityNotFoundException {
