...
package com.testing15thnov_stage.wmstudio.controller;
...
import com.testing15thnov_stage.wmstudio.service.IncludeService;
...
@ApiOperation(value = "Returns the Include instance associated with the given composite-id.")
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Include getInclude(@RequestParam("id") BigInteger id,@RequestParam("firstName") String firstName,@RequestParam("salary") Double salary,@RequestParam("salary2") BigInteger salary2) throws EntityNotFoundException {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Include editInclude(@RequestParam("id") BigInteger id,@RequestParam("firstName") String firstName,@RequestParam("salary") Double salary,@RequestParam("salary2") BigInteger salary2, @RequestBody Include include) throws EntityNotFoundException {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public boolean deleteInclude(@RequestParam("id") BigInteger id,@RequestParam("firstName") String firstName,@RequestParam("salary") Double salary,@RequestParam("salary2") BigInteger salary2) throws EntityNotFoundException {
    ...
    public Page<Include> searchIncludesByQueryFilters( Pageable pageable, @RequestBody QueryFilter[] queryFilters) {
        LOGGER.debug("Rendering Includes list");
