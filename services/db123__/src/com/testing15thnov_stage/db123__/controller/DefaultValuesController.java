...
import com.testing15thnov_stage.db123__.DefaultValues;
import com.testing15thnov_stage.db123__.service.DefaultValuesService;
...
public DefaultValues createDefaultValues(@RequestPart("wm_data_json") DefaultValues defaultValues, @RequestPart(value = "blobCol", required = false) MultipartFile _blobCol) {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public DefaultValues getDefaultValues(@PathVariable("id") Integer id) throws EntityNotFoundException {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public DefaultValues editDefaultValues(@PathVariable("id") Integer id, @RequestBody DefaultValues defaultValues) throws EntityNotFoundException {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public DefaultValues editDefaultValues(@PathVariable("id") Integer id, MultipartHttpServletRequest multipartHttpServletRequest) throws EntityNotFoundException {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public boolean deleteDefaultValues(@PathVariable("id") Integer id) throws EntityNotFoundException {
    ...
    public Page<DefaultValues> searchDefaultValuesByQueryFilters( Pageable pageable, @RequestBody QueryFilter[] queryFilters) {
        LOGGER.debug("Rendering DefaultValues list");
