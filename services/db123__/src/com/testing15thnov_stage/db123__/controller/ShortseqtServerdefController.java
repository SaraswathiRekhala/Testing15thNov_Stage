...
import com.testing15thnov_stage.db123__.service.ShortseqtServerdefService;
...
public ShortseqtServerdef createShortseqtServerdef(@RequestBody ShortseqtServerdef shortseqtServerdef) {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public ShortseqtServerdef getShortseqtServerdef(@PathVariable("id") Integer id) throws EntityNotFoundException {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public ShortseqtServerdef editShortseqtServerdef(@PathVariable("id") Integer id, @RequestBody ShortseqtServerdef shortseqtServerdef) throws EntityNotFoundException {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public boolean deleteShortseqtServerdef(@PathVariable("id") Integer id) throws EntityNotFoundException {
    ...
    public Page<ShortseqtServerdef> searchShortseqtServerdefsByQueryFilters( Pageable pageable, @RequestBody QueryFilter[] queryFilters) {
        LOGGER.debug("Rendering ShortseqtServerdefs list");
