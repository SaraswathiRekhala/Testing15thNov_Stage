...
import com.testing15thnov_stage.dbscenarios.service.AccountService;
 ...
 * @see Account
 */
@RestController("dbscenarios.AccountController")
@Api(value = "AccountController", description = "Exposes APIs to work with Account resource.")
@RequestMapping("/dbscenarios/Account")
public class AccountController {

    private static final Logger LOGGER = LoggerFactory.getLogger(AccountController.class);

    @Autowired
	@Qualifier("dbscenarios.AccountService")
