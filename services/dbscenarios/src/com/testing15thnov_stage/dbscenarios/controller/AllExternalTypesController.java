...
import com.testing15thnov_stage.dbscenarios.service.AllExternalTypesService;
...
public AllExternalTypes createAllExternalTypes(@RequestPart("wm_data_json") AllExternalTypes allExternalTypes, @RequestPart(value = "blobCol", required = false) MultipartFile _blobCol, @RequestPart(value = "longblobCol", required = false) MultipartFile _longblobCol) {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public AllExternalTypes getAllExternalTypes(@PathVariable("id") Integer id) throws EntityNotFoundException {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public AllExternalTypes editAllExternalTypes(@PathVariable("id") Integer id, @RequestBody AllExternalTypes allExternalTypes) throws EntityNotFoundException {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public AllExternalTypes editAllExternalTypes(@PathVariable("id") Integer id, MultipartHttpServletRequest multipartHttpServletRequest) throws EntityNotFoundException {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public boolean deleteAllExternalTypes(@PathVariable("id") Integer id) throws EntityNotFoundException {
