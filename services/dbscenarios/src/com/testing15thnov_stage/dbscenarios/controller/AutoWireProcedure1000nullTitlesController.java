...
import com.testing15thnov_stage.dbscenarios.service.AutoWireProcedure1000nullTitlesService;
...
public AutoWireProcedure1000nullTitles createAutoWireProcedure1000nullTitles(@RequestBody AutoWireProcedure1000nullTitles autoWireProcedure1000nullTitles) {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public AutoWireProcedure1000nullTitles getAutoWireProcedure1000nullTitles(@PathVariable("id") Integer id) throws EntityNotFoundException {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public AutoWireProcedure1000nullTitles editAutoWireProcedure1000nullTitles(@PathVariable("id") Integer id, @RequestBody AutoWireProcedure1000nullTitles autoWireProcedure1000nullTitles) throws EntityNotFoundException {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public boolean deleteAutoWireProcedure1000nullTitles(@PathVariable("id") Integer id) throws EntityNotFoundException {
    ...
    public Page<AutoWireProcedure1000nullTitles> searchAutoWireProcedure1000nullTitlesByQueryFilters( Pageable pageable, @RequestBody QueryFilter[] queryFilters) {
        LOGGER.debug("Rendering AutoWireProcedure1000nullTitles list");
