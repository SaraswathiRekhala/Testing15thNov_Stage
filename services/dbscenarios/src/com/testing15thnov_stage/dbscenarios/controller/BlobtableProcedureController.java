...
import com.testing15thnov_stage.dbscenarios.service.BlobtableProcedureService;
...
public BlobtableProcedure createBlobtableProcedure(@RequestPart("wm_data_json") BlobtableProcedure blobtableProcedure, @RequestPart(value = "blobcol", required = false) MultipartFile _blobcol) {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public BlobtableProcedure getBlobtableProcedure(@PathVariable("id") Integer id) throws EntityNotFoundException {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public BlobtableProcedure editBlobtableProcedure(@PathVariable("id") Integer id, @RequestBody BlobtableProcedure blobtableProcedure) throws EntityNotFoundException {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public BlobtableProcedure editBlobtableProcedure(@PathVariable("id") Integer id, MultipartHttpServletRequest multipartHttpServletRequest) throws EntityNotFoundException {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public boolean deleteBlobtableProcedure(@PathVariable("id") Integer id) throws EntityNotFoundException {
    ...
    public Page<BlobtableProcedure> searchBlobtableProceduresByQueryFilters( Pageable pageable, @RequestBody QueryFilter[] queryFilters) {
        LOGGER.debug("Rendering BlobtableProcedures list");
