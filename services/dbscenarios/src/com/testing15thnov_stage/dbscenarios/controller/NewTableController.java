...
import com.testing15thnov_stage.dbscenarios.NewTable;
import com.testing15thnov_stage.dbscenarios.NewTableId;
import com.testing15thnov_stage.dbscenarios.service.NewTableService;
...
@ApiOperation(value = "Returns the NewTable instance associated with the given composite-id.")
    @RequestMapping(value = "/composite-id", method = RequestMethod.GET)
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public NewTable getNewTable(@RequestParam("id") Integer id,@RequestParam("stringcol_45_") String stringcol_45_,@RequestParam("datecol1") Date datecol1) throws EntityNotFoundException {

        NewTableId newtableId = new NewTableId();
        newtableId.setId(id);
        newtableId.setStringcol_45_(stringcol_45_);
        newtableId.setDatecol1(datecol1);

        LOGGER.debug("Getting NewTable with id: {}" , newtableId);
        NewTable newTable = newTableService.getById(newtableId);
    ...
    @ApiOperation(value = "Updates the NewTable instance associated with the given composite-id.")
    @RequestMapping(value = "/composite-id", method = RequestMethod.PUT)
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public NewTable editNewTable(@RequestParam("id") Integer id,@RequestParam("stringcol_45_") String stringcol_45_,@RequestParam("datecol1") Date datecol1, @RequestBody NewTable newTable) throws EntityNotFoundException {

        newTable.setId(id);
        newTable.setStringcol_45_(stringcol_45_);
        newTable.setDatecol1(datecol1);

        LOGGER.debug("NewTable details with id is updated with: {}" , newTable);

        return newTableService.update(newTable);
    }


    @ApiOperation(value = "Deletes the NewTable instance associated with the given composite-id.")
    @RequestMapping(value = "/composite-id", method = RequestMethod.DELETE)
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public boolean deleteNewTable(@RequestParam("id") Integer id,@RequestParam("stringcol_45_") String stringcol_45_,@RequestParam("datecol1") Date datecol1) throws EntityNotFoundException {
        ...
        NewTable newTable = newTableService.delete(newtableId);
    ...
    @ApiOperation(value = "Returns the matching NewTable with given unique key values.")
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public NewTable getByUniqueKeyId(@PathVariable("id") int id) {
        LOGGER.debug("Getting NewTable with uniques key UniqueKeyId");
        return newTableService.getByUniqueKeyId(id);
    }
