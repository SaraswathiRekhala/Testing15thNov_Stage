...
import com.testing15thnov_stage.dbscenarios.service.TOne2oneCService;
...
public TOne2oneC createTOne2oneC(@RequestBody TOne2oneC tone2oneC) {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public TOne2oneC getTOne2oneC(@PathVariable("id") Short id) throws EntityNotFoundException {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public TOne2oneC editTOne2oneC(@PathVariable("id") Short id, @RequestBody TOne2oneC tone2oneC) throws EntityNotFoundException {
        LOGGER.debug("Editing TOne2oneC with id: {}" , tone2oneC.getByteId());

        tone2oneC.setByteId(id);
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public boolean deleteTOne2oneC(@PathVariable("id") Short id) throws EntityNotFoundException {
    ...
    @ApiOperation(value = "Returns the paginated list of TOne2oneC instances matching the optional query (q) request param. If there is no query provided, it returns all the instances. Pagination & Sorting parameters such as page& size, sort can be sent as request parameters. The sort value should be a comma separated list of field names & optional sort order to sort the data on. eg: field1 asc, field2 desc etc ")
    ...
    @ApiOperation(value = "Returns the paginated list of TOne2oneC instances matching the optional query (q) request param. This API should be used only if the query string is too big to fit in GET request with request param. The request has to made in application/x-www-form-urlencoded format.")
    @RequestMapping(value="/filter", method = RequestMethod.POST, consumes= "application/x-www-form-urlencoded")
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Page<TOne2oneC> filterTOne2oneCs(@ApiParam("conditions to filter the results") @RequestParam(value = "q", required = false) String query, Pageable pageable) {
        LOGGER.debug("Rendering TOne2oneCs list");
        return tOne2oneCService.findAll(query, pageable);
    }
	...
	@ApiOperation(value = "Returns the total count of TOne2oneC instances matching the optional query (q) request param. If query string is too big to fit in GET request's query param, use POST method with application/x-www-form-urlencoded format.")
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
	public Page<Map<String, Object>> getTOne2oneCAggregatedValues(@RequestBody AggregationInfo aggregationInfo, Pageable pageable) {
        LOGGER.debug("Fetching aggregated results for {}", aggregationInfo);
        return tOne2oneCService.getAggregatedValues(aggregationInfo, pageable);
    }
