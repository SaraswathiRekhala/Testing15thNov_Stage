...
import com.testing15thnov_stage.dbscenarios.service.TUcComposites2Service;
...
@ApiOperation(value = "Returns the TUcComposites2 instance associated with the given composite-id.")
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public TUcComposites2 getTUcComposites2(@RequestParam("byteId") Short byteId,@RequestParam("charCol") String charCol,@RequestParam("shortCol") Short shortCol,@RequestParam("stringCol") String stringCol) throws EntityNotFoundException {
        ...
        tuccomposites2Id.setShortCol(shortCol);
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public TUcComposites2 editTUcComposites2(@RequestParam("byteId") Short byteId,@RequestParam("charCol") String charCol,@RequestParam("shortCol") Short shortCol,@RequestParam("stringCol") String stringCol, @RequestBody TUcComposites2 tucComposites2) throws EntityNotFoundException {

        tucComposites2.setByteId(byteId);
        tucComposites2.setCharCol(charCol);
        tucComposites2.setShortCol(shortCol);
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public boolean deleteTUcComposites2(@RequestParam("byteId") Short byteId,@RequestParam("charCol") String charCol,@RequestParam("shortCol") Short shortCol,@RequestParam("stringCol") String stringCol) throws EntityNotFoundException {
    ...
    @ApiOperation(value = "Returns the paginated list of TUcComposites2 instances matching the optional query (q) request param. This API should be used only if the query string is too big to fit in GET request with request param. The request has to made in application/x-www-form-urlencoded format.")
    @RequestMapping(value="/filter", method = RequestMethod.POST, consumes= "application/x-www-form-urlencoded")
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Page<TUcComposites2> filterTUcComposites2s(@ApiParam("conditions to filter the results") @RequestParam(value = "q", required = false) String query, Pageable pageable) {
        LOGGER.debug("Rendering TUcComposites2s list");
        return tUcComposites2Service.findAll(query, pageable);
    }
	...
	@ApiOperation(value = "Returns the total count of TUcComposites2 instances matching the optional query (q) request param. If query string is too big to fit in GET request's query param, use POST method with application/x-www-form-urlencoded format.")
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
	public Page<Map<String, Object>> getTUcComposites2AggregatedValues(@RequestBody AggregationInfo aggregationInfo, Pageable pageable) {
        LOGGER.debug("Fetching aggregated results for {}", aggregationInfo);
        return tUcComposites2Service.getAggregatedValues(aggregationInfo, pageable);
    }
