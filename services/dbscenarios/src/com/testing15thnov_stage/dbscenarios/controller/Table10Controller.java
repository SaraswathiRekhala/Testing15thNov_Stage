...
import com.testing15thnov_stage.dbscenarios.service.Table10Service;
...
public Table10 createTable10(@RequestBody Table10 table10) {
    ...
    @RequestMapping(value = "/column2-column3", method = RequestMethod.GET)
    @ApiOperation(value = "Returns the matching Table10 with given unique key values.")
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Table10 getByColumn2AndColumn3(@RequestParam("column2") String column2, @RequestParam("column3") String column3) {
        LOGGER.debug("Getting Table10 with uniques key Column2AndColumn3");
        return table10Service.getByColumn2AndColumn3(column2, column3);
    }
