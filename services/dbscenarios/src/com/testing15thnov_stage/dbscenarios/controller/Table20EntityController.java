...
import com.testing15thnov_stage.dbscenarios.service.Table20EntityService;
...
public class Table20EntityController {
    ...
    @Autowired
	@Qualifier("dbscenarios.Table20EntityService")
...
public Table20Entity createTable20Entity(@RequestBody Table20Entity table20entity) {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Table20Entity getTable20Entity(@PathVariable("id") Integer id) throws EntityNotFoundException {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Table20Entity editTable20Entity(@PathVariable("id") Integer id, @RequestBody Table20Entity table20entity) throws EntityNotFoundException {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public boolean deleteTable20Entity(@PathVariable("id") Integer id) throws EntityNotFoundException {
    ...
    public Page<Table20Entity> searchTable20EntitiesByQueryFilters( Pageable pageable, @RequestBody QueryFilter[] queryFilters) {
        LOGGER.debug("Rendering Table20Entities list");
