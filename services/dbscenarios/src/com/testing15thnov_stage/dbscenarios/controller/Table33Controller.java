...
import com.testing15thnov_stage.dbscenarios.service.Table33Service;
...
public Table33 createTable33(@RequestBody Table33 table33) {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Table33 getTable33(@PathVariable("id") String id) throws EntityNotFoundException {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Table33 editTable33(@PathVariable("id") String id, @RequestBody Table33 table33) throws EntityNotFoundException {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public boolean deleteTable33(@PathVariable("id") String id) throws EntityNotFoundException {
    ...
    public Page<Table33> searchTable33sByQueryFilters( Pageable pageable, @RequestBody QueryFilter[] queryFilters) {
        LOGGER.debug("Rendering Table33s list");
