...
import com.testing15thnov_stage.dbscenarios.service.UpService;
...
public Up createUp(@RequestBody Up up) {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Up getUp(@PathVariable("id") Integer id) throws EntityNotFoundException {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Up editUp(@PathVariable("id") Integer id, @RequestBody Up up) throws EntityNotFoundException {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public boolean deleteUp(@PathVariable("id") Integer id) throws EntityNotFoundException {
    ...
    public Page<Up> searchUpsByQueryFilters( Pageable pageable, @RequestBody QueryFilter[] queryFilters) {
        LOGGER.debug("Rendering Ups list");
