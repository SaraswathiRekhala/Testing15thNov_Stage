...
public interface AllExternalTypesService {
     ...
     */
	AllExternalTypes create(@Valid AllExternalTypes allExternalTypes);
	 ...
	 */
	AllExternalTypes getById(Integer allexternaltypesId) throws EntityNotFoundException;
	 ...
	 * @return AllExternalTypes associated with the given allexternaltypesId.
	 */
	AllExternalTypes findById(Integer allexternaltypesId);
	 ...
	 */
	AllExternalTypes update(@Valid AllExternalTypes allExternalTypes) throws EntityNotFoundException;
	 ...
	 */
	AllExternalTypes delete(Integer allexternaltypesId) throws EntityNotFoundException;
