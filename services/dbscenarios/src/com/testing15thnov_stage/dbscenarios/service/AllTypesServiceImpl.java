...
import com.testing15thnov_stage.dbscenarios.AllTypes;
 ...
 * @see AllTypes
 */
@Service("dbscenarios.AllTypesService")
@Validated
public class AllTypesServiceImpl implements AllTypesService {
    ...
    @Autowired
    @Qualifier("dbscenarios.AllTypesDao")
    ...
    public Downloadable export(ExportType exportType, String query, Pageable pageable) {
        LOGGER.debug("exporting data in the service dbscenarios for table AllTypes to {} format", exportType);
