 ...
 * @see Blobtypes
 */
@Service("dbscenarios.BlobtypesService")
@Validated
public class BlobtypesServiceImpl implements BlobtypesService {
    ...
    @Autowired
    @Qualifier("dbscenarios.BlobtypesDao")
    ...
    public Downloadable export(ExportType exportType, String query, Pageable pageable) {
        LOGGER.debug("exporting data in the service dbscenarios for table Blobtypes to {} format", exportType);
