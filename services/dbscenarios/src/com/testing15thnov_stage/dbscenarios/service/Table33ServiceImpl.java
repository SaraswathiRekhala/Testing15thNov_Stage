 ...
 * @see Table33
 */
@Service("dbscenarios.Table33Service")
@Validated
public class Table33ServiceImpl implements Table33Service {
    ...
    @Autowired
    @Qualifier("dbscenarios.Table33Dao")
    private WMGenericDao<Table33, String> wmGenericDao;

    public void setWMGenericDao(WMGenericDao<Table33, String> wmGenericDao) {
	...
	@Override
	public Table33 getById(String table33Id) throws EntityNotFoundException {
    ...
    @Transactional(readOnly = true, value = "dbscenariosTransactionManager")
	@Override
	public Table33 findById(String table33Id) {
        LOGGER.debug("Finding Table33 by id: {}", table33Id);
	...
	public Table33 update(Table33 table33) throws EntityNotFoundException {
        ...
        String table33Id = table33.getId();
    ...
    @Transactional(value = "dbscenariosTransactionManager")
	@Override
	public Table33 delete(String table33Id) throws EntityNotFoundException {
    ...
    public Downloadable export(ExportType exportType, String query, Pageable pageable) {
        LOGGER.debug("exporting data in the service dbscenarios for table Table33 to {} format", exportType);
