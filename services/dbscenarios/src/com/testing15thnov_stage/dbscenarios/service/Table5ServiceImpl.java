 ...
 * @see Table5
 */
@Service("dbscenarios.Table5Service")
@Validated
public class Table5ServiceImpl implements Table5Service {
    ...
    @Autowired
    @Qualifier("dbscenarios.Table5Dao")
    ...
    public Downloadable export(ExportType exportType, String query, Pageable pageable) {
        LOGGER.debug("exporting data in the service dbscenarios for table Table5 to {} format", exportType);
