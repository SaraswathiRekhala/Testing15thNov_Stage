 ...
 * @see Table8
 */
@Service("dbscenarios.Table8Service")
@Validated
public class Table8ServiceImpl implements Table8Service {
    ...
    @Autowired
    @Qualifier("dbscenarios.Table8Dao")
	...
	public Table8 create(Table8 table8) {
        ...
        if(table8Created.getTable8sForColumn2() != null) {
            for(Table8 table8sForColumn2 : table8Created.getTable8sForColumn2()) {
                table8sForColumn2.setTable8ByColumn2(table8Created);
                LOGGER.debug("Creating a new child Table8 with information: {}", table8sForColumn2);
                create(table8sForColumn2);
            }
        }
    ...
    public Downloadable export(ExportType exportType, String query, Pageable pageable) {
        LOGGER.debug("exporting data in the service dbscenarios for table Table8 to {} format", exportType);
    ...
    @Transactional(readOnly = true, value = "dbscenariosTransactionManager")
    @Override
    public Page<Table8> findAssociatedTable8sForColumn2(Integer id, Pageable pageable) {
        LOGGER.debug("Fetching all associated table8sForColumn2");

        StringBuilder queryBuilder = new StringBuilder();
        queryBuilder.append("table8ByColumn2.id = '" + id + "'");
