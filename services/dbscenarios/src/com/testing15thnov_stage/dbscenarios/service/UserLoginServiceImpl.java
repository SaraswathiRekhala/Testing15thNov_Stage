 ...
 * @see UserLogin
 */
@Service("dbscenarios.UserLoginService")
@Validated
public class UserLoginServiceImpl implements UserLoginService {
    ...
    @Autowired
    @Qualifier("dbscenarios.UserLoginDao")
    private WMGenericDao<UserLogin, Short> wmGenericDao;

    public void setWMGenericDao(WMGenericDao<UserLogin, Short> wmGenericDao) {
	...
	@Override
	public UserLogin getById(Short userloginId) throws EntityNotFoundException {
    ...
    @Transactional(readOnly = true, value = "dbscenariosTransactionManager")
	@Override
	public UserLogin findById(Short userloginId) {
        LOGGER.debug("Finding UserLogin by id: {}", userloginId);
	...
	public UserLogin update(UserLogin userLogin) throws EntityNotFoundException {
        ...
        Short userloginId = userLogin.getUserId();
    ...
    @Transactional(value = "dbscenariosTransactionManager")
	@Override
	public UserLogin delete(Short userloginId) throws EntityNotFoundException {
    ...
    public Downloadable export(ExportType exportType, String query, Pageable pageable) {
        LOGGER.debug("exporting data in the service dbscenarios for table UserLogin to {} format", exportType);
